...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.naren.sample.grpc.GreetRequest,
      com.naren.sample.grpc.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = com.naren.sample.grpc.GreetRequest.class,
      responseType = com.naren.sample.grpc.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.naren.sample.grpc.GreetRequest,
      com.naren.sample.grpc.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.naren.sample.grpc.GreetRequest, com.naren.sample.grpc.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<com.naren.sample.grpc.GreetRequest, com.naren.sample.grpc.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.naren.sample.grpc.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.naren.sample.grpc.GreetResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void greet(com.naren.sample.grpc.GreetRequest request,
        io.grpc.stub.StreamObserver<com.naren.sample.grpc.GreetResponse> responseObserver) {
  ...
  public static final class GreetServiceStub
     ...
     * </pre>
     */
    public void greet(com.naren.sample.grpc.GreetRequest request,
        io.grpc.stub.StreamObserver<com.naren.sample.grpc.GreetResponse> responseObserver) {
  ...
  public static final class GreetServiceBlockingStub
     ...
     * </pre>
     */
    public com.naren.sample.grpc.GreetResponse greet(com.naren.sample.grpc.GreetRequest request) {
  ...
  public static final class GreetServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.naren.sample.grpc.GreetResponse> greet(
        com.naren.sample.grpc.GreetRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.naren.sample.grpc.GreetRequest) request,
              (io.grpc.stub.StreamObserver<com.naren.sample.grpc.GreetResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.naren.sample.grpc.GreetRequest,
              com.naren.sample.grpc.GreetResponse>(
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.naren.sample.grpc.GreetProto.getDescriptor();
    }
