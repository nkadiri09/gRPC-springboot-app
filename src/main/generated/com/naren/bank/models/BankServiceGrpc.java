...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.naren.bank.models.BalanceRequest,
      com.naren.bank.models.BalanceResponse> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBalance",
      requestType = com.naren.bank.models.BalanceRequest.class,
      responseType = com.naren.bank.models.BalanceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.naren.bank.models.BalanceRequest,
      com.naren.bank.models.BalanceResponse> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.naren.bank.models.BalanceRequest, com.naren.bank.models.BalanceResponse> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.naren.bank.models.BalanceRequest, com.naren.bank.models.BalanceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.naren.bank.models.BalanceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.naren.bank.models.BalanceResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getBalance(com.naren.bank.models.BalanceRequest request,
        io.grpc.stub.StreamObserver<com.naren.bank.models.BalanceResponse> responseObserver) {
  ...
  public static final class BankServiceStub
    ...
    /**
     */
    public void getBalance(com.naren.bank.models.BalanceRequest request,
        io.grpc.stub.StreamObserver<com.naren.bank.models.BalanceResponse> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
    ...
    /**
     */
    public com.naren.bank.models.BalanceResponse getBalance(com.naren.bank.models.BalanceRequest request) {
  ...
  public static final class BankServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.naren.bank.models.BalanceResponse> getBalance(
        com.naren.bank.models.BalanceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.naren.bank.models.BalanceRequest) request,
              (io.grpc.stub.StreamObserver<com.naren.bank.models.BalanceResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.naren.bank.models.BalanceRequest,
              com.naren.bank.models.BalanceResponse>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.naren.bank.models.BankServiceOuterClass.getDescriptor();
    }
